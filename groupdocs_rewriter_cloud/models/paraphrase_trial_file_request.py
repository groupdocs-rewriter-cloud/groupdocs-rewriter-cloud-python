...
class ParaphraseTrialFileRequest(BaseModel):
    ...
    __properties = ["language", "file", "url", "origin", "originalName", "savingMode", "diversityDegree", "format"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ParaphraseTrialFileRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ParaphraseTrialFileRequest:
        """Create an instance of ParaphraseTrialFileRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ParaphraseTrialFileRequest.parse_obj(obj)

        _obj = ParaphraseTrialFileRequest.parse_obj({
