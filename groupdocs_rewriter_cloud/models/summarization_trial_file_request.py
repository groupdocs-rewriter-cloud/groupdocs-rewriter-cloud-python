...
from pydantic import BaseModel, Field, StrictBytes, StrictInt, StrictStr, constr
...
class SummarizationTrialFileRequest(BaseModel):
    ...
    __properties = ["language", "file", "url", "origin", "originalName", "savingMode", "summarizationDegree", "minLength", "format"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SummarizationTrialFileRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SummarizationTrialFileRequest:
        """Create an instance of SummarizationTrialFileRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SummarizationTrialFileRequest.parse_obj(obj)

        _obj = SummarizationTrialFileRequest.parse_obj({
