...
class SynonymizeTextRequest(BaseModel):
    ...
    synonyms: Optional[StrictStr] = Field(None, description="Number of variants for rewriting")
    __properties = ["language", "text", "texts", "origin", "synonyms"]
    ...
    def synonyms_validate_enum(cls, value):
        ...
        if value not in ('All', 'One', 'Two', 'Three', 'Four', 'Five'):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SynonymizeTextRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SynonymizeTextRequest:
        """Create an instance of SynonymizeTextRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SynonymizeTextRequest.parse_obj(obj)

        _obj = SynonymizeTextRequest.parse_obj({
