...
class ParaphraseFileRequest(BaseModel):
    ...
    __properties = ["language", "file", "url", "origin", "originalName", "savingMode", "outputFormat", "diversityDegree", "format"]
    ...
    def format_validate_enum(cls, value):
        ...
        if value not in ('Unknown', 'Doc', 'Docx', 'Docm', 'Rtf', 'Odt', 'Txt', 'Pdf', 'Md', 'Html'):
            raise ValueError("must be one of enum values ('Unknown', 'Doc', 'Docx', 'Docm', 'Rtf', 'Odt', 'Txt', 'Pdf', 'Md', 'Html')")
        return value
